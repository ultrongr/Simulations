...
class Win:
    ...
    def populate(self):
        ...
        self.planets.append(Planet(self.canvas, x=5, y=5.360, velocity=(1.082,0), radius=1.737, mass=7.3*10**22 , color="grey", personal_display_size=10**-1.5,immovable=False))
